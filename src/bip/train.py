...
class BIPTrainer:
    ...
    def __init__(self, config: dict, split_name: str = "temporal_holdout"):
        ...
        if not splits_file.exists():
            raise FileNotFoundError(f"Splits file not found: {splits_file}. Run generate_splits first.")
        ...
        self.train_loader = DataLoader(
            ...
            collate_fn=collate_fn, num_workers=0  # Use 0 for Windows compatibility
        )
